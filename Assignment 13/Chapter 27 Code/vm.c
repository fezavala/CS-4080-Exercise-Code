...
// Native function that checks if the named field exists in the instance's fields table
...
void initVM() {
    ...
    // Define the field checking native
    defineNative("hasField", hasFieldNative);
    // Define get and set field natives
    defineNative("getField", getFieldNative);
    defineNative("setField", setFieldNative);
    // Define native that deletes fields from the instances field table
