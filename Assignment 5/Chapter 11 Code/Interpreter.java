...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    // Locals uses a {depth, index] array
    ...
    void resolve(Expr expr, int depth, int index) {
        int[] locationTuple = new int[2];
        locationTuple[0] = index;
        locationTuple[1] = depth;
        locals.put(expr, locationTuple);
    }
    ...
    public Object visitAssignExpr(Expr.Assign expr) {
        ...
        if (distance != null) {
            environment.assignAt(distance[0], expr.name, value);
        } else {
